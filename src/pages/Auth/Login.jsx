    ...
    <PublicLayout>
      <div className="auth-page">
        ...
        <form onSubmit={handleSubmit} className="auth-page__form">
          ...
          <div className="auth-page__group auth-page__group--password">
        ...
        {/* OR SEPARATOR */}
        <div className="auth-page__or-separator">
            <span>OR</span>
        </div>

        {/* SOCIAL LOGIN BUTTONS (Placeholder for premium look) */}
        <div className="auth-page__social-login">
            <button className="social-btn social-btn--google" disabled>
                <img src="https://upload.wikimedia.org/wikipedia/commons/thumb/c/c1/Google_%22G%22_logo.svg/512px-Google_%22G%22_logo.svg.png" alt="Google logo" width="20" height="20" />
                Sign in with Google
            </button>
            {/* You can add more social buttons here */}
        </div>
        
        {/* Removed the 'Sign up' link here as requested. */}
